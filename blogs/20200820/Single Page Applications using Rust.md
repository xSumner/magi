...
![img](img/rust-wasm-yew-single-page-application-1.png)
...
![img](img/rust-wasm-yew-single-page-application-2.png)
...
![img](img/rust-wasm-yew-single-page-application-3.png)
...
![img](img/rust-wasm-yew-single-page-application-4.png)
...
![img](img/rust-wasm-yew-single-page-application-5.png)
...
![img](img/rust-wasm-yew-single-page-application-6.png)
...
![img](img/rust-wasm-yew-single-page-application-7.png)
...
![img](img/rust-wasm-yew-single-page-application-8.png)
...
![img](img/rust-wasm-yew-single-page-application-9.png)
...
The Yew community has done a good job designing abstractions like `html!`, `Component` etc so someone like me who’s familiar with React can immediately start being productive. It definitely has some rough edges like FetchTask, lack of [*predictable*](https://redux.js.org/introduction/motivation) state management and the documentation is sparse, but has potential to become a good alternative to React, Vue etc once these issues are fixed.

Thanks for reading! Feel free to follow me in [Twitter](https://twitter.com/sheshbabu) for more posts like this :)

Tagged under: [Rust](http://www.sheshbabu.com/tags/Rust/)

Published on: 11 Aug 2020

© 2020 Sheshbabu Chinnakonda